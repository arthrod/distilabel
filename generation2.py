...
handler = logging.FileHandler("generatlogg2.log")
...
async def main():
    ...
    with Pipeline(name="text_generation") as pipeline:
        ...
        # Access the "default" -> "train" data
        train_data = result["default"]["train"]
        logger.debug(f"Result data to be saved: {train_data}")
